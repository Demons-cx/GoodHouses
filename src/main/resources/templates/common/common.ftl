                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <article>
                                <h3>关于我们</h3>
                                <p> 好房网集房源信息搜索、产品研发、大数据处理、服务标准建立为一体的以数据驱动的全价值链房产服务平台。好房网的前身为好房在线，成立于2010年并于2014年正式更名为好房网。目前，好房网线上房源已覆盖北京、上海、广州、深圳、杭州、天津、成都、重庆、大连等36个地区。在房产交易服务领域，好房网旨在通过“链接人与服务”不断提高服务效率、提升服务体验，为用户提供更安全、更便捷、更舒心的综合房产服务，致力于实现推动行业进步，让房屋交易不再难的企业愿景。
                                </p>
                                <hr>
                            </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
                            <article>
                                ...
                                13083163861<br>
                                <a href="#">cx13083163861@163.com</a>
                            </article>
                        </div><!-- /.col-sm-3 -->
                        <div class="col-md-3 col-sm-3">
                            <article>
